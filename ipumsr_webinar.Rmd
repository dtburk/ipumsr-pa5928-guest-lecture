...
```{r echo=FALSE, fig.alt="Trends in multigenerational households by income level and race/ethnicity.", fig.height=3, fig.width=5}
knitr::include_graphics("images/example_usa1.png")
```
